    ...
    <div class="container">
        @if (auth()->user()->role !== 'admin')
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                Accès non autorisé. Seuls les administrateurs peuvent modifier des utilisateurs.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        @else
            <h1 class="mb-4 text-center" style="font-weight: 600; color: #1e3a8a;">Modifier un utilisateur</h1>
